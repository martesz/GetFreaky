...
public class RetrofitClient {
    ...
    public static String BASE_URL = "https://192.168.1.4:20286/getFreakyService/";
    ...
    public RetrofitClient(final GlobalVariables application) {
        ...
        clientBuilder.addInterceptor(new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                String serverSocket = application.getServerSocket();
                if(serverSocket != null) {
                    BASE_URL = "https://" + serverSocket + "/getFreakyService/";
                }

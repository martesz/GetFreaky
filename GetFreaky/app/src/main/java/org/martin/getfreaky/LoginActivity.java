...
public class LoginActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button setServerUrlButton = (Button) findViewById(R.id.set_server_url_button);
        setServerUrlButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                String url = mEmailView.getText().toString();
                application.setServerSocket(url);
            }
        });
    }
